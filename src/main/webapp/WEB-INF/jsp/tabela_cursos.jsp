                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover display compact" id="grid">
                         ...
                         <tbody>
                             <c:forEach items="${listCursos}" var="curso"> 
                                <tr>              
                                    <td class="odd gradeX" align="center" th:text="${curso.id}">${curso.id}</td>
                                    <td class="odd gradeX" align="center" th:text="${curso.nome}">${curso.nome}</td>
                                    <td class="odd gradeX" align="center">
                                       <a href="/deletarCurso/${curso.id}">Delete</a>
                                    </td>
                                </tr>
                             </c:forEach>
                         </tbody>
